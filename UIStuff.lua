...
local RayfieldLibrary = {
	...
	Theme = {
        ...
        Yellow = {
			...
			SliderBackground = Color3.fromRGB(43, 105, 159),
			SliderProgress = Color3.fromRGB(43, 105, 159),
			SliderStroke = Color3.fromRGB(43, 105, 159),
...
local Rayfield =  game:GetObjects("rbxassetid://16826461818")[1] --14412610844
...
function Unhide()
	...
	Main.Visible = true
	TweenService:Create(Main, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {Size = UDim2.new(0.816, 0,0.687, 0)}):Play()
...
function RayfieldLibrary:CreateWindow(Settings)
    ...
    task.wait(.03)
	TweenService:Create(Main, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {Size = UDim2.new(0.816, 0,0.687, 0)}):Play()
	TweenService:Create(Main.Shadow.Image, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {ImageTransparency = 0.4}):Play()
